...
public class SearchWayActivity extends Activity implements OnClickListener {
 //SearchWayActivity类为寻找路线
	private Button change;//切换

	private Button setStartOrEnd;//起点设置

	private Button setEndOrStart;//终点设置

	private Button bus;//公交

	private Button drive;//驾车

	private Button walk;//步行
	...
	public void findViews() {
		...
		change.setText(R.string.route_dialog_swap);
		...
		drive.setText(R.string.route_dialog_driving);
	...
	public void onClick(View v) {
		...
		case R.id.searchRoute: {
			...
			if ("".equals(find_the_way)) {
				Toast.makeText(SearchWayActivity.this, R.string.policy_tip,
						Toast.LENGTH_SHORT).show();
			} else {
				i = new Intent(SearchWayActivity.this, DriveActivity.class);
				if (bus.isClickable() == false && drive.isClickable() == false
				...
				} else if ("drive".equals(find_the_way)) {
					i.putExtra("find_the_way", "drive");
					i.putExtra("drivingPolicy", drivingPolicy);
				...
				if (("").equals(start) && ("").equals(end)) {
					Toast.makeText(SearchWayActivity.this,
					...
					SearchWayActivity.this.startActivity(i);
	...
	public void createSetDialog(final String flag) {
		...
		AlertDialog dialog = new AlertDialog.Builder(SearchWayActivity.this)
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 1: {
							if (dialogFlag.equals("pick")) {// 获取地图上第二个点
								i = new Intent(SearchWayActivity.this,
										ChSecondMapActivity.class);
							} else {// 获取地图上第一个点
								i = new Intent(SearchWayActivity.this,
	...
	public void createDialog(String flag) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(
				SearchWayActivity.this, android.R.layout.simple_spinner_item);
