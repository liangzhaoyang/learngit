...
public class DriveActivity extends MapActivity implements OnClickListener {
	...
	public class MySearchListener implements MKSearchListener {
		...
		public void onGetDrivingRouteResult(MKDrivingRouteResult res, int error) {
			...
			if (error != 0 || res == null) {
				Toast.makeText(DriveActivity.this, R.string.poi_result_tip,
			...
			RouteOverlay routeOverlay = new RouteOverlay(DriveActivity.this,
					mMapView);
		...
		public void onGetTransitRouteResult(MKTransitRouteResult result,
			...
			busAdapter = new BusAdapter(DriveActivity.this, result);
			popAwindow("bus");
		}
	...
	public void onClick(View v) {
		...
		case R.id.searchRoute: {
			i = new Intent(DriveActivity.this, SearchWayActivity.class);
			i.putExtra("flag", "");
		...
		case R.id.searchPoi: {
			i = new Intent(DriveActivity.this, NearActivity.class);
			i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(i);
	...
	private void popAwindow(String flag) {
		...
		dialog = new AlertDialog.Builder(DriveActivity.this)
