...
<head>
	...
	<script type="text/javascript" src="<%=path%>/js/resume/resumeXq.js"></script>
</head>
<body>

	<form id="jlxq11" name="jlxq11" action="jlxq11.do" method="post">
				...
				<table width="98%">
					<tr>
						...
						<td class="formTdLeft"  style="width:10%"><span style='color: red'>*</span>性别：</td>
						 <td class="formTdRight" style="width:25%">
						 	<select name="xingbie" id="xingbie" class="select" style="width:50%" >
					...
					<tr>
						...
						<td class="formTdRight" style="width:25%">
							<input type="text" name="chushengnianyue" value="" id="chushengnianyue" class="input"/>
						</td>
					</tr>
					<tr>
						<td class="formTdLeft" style="width:25%"><span style='color: red'>*</span>政治面貌：</td>
						<td class="formTdRight" style="width:25%">
							<select name="zhengzhimianmao" id="zhengzhimianmao" class="select"  onchange="selChange(this.value)">
							    <option value="7" selected="selected">请选择</option>
						...
						<td class="formTdRight" style="width:25%">
							<input type="text" name="canjiagongzuoshijian" value="" id="canjiagongzuoshijian" class="input"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="formTdRight" style="width:25%">
							<select name="leibie" id="leibie" class="select" onchange="selChange(this.value)">
							    <option value="7" selected="selected">请选择</option>
			...
			<tr>
				...
				<table width="98%">
					...
					<tr>
						<td class="formTdLeft" style="width:25%"><span style='color: red'>*</span>出生年份：</td>
							<td class="formTdRight" style="width:25%">
							<input type="text" name="chushengnianfen1" value="" id="chushengnianfen1" class="input"/>
							
					<td class="formTdLeft" style="width:25%"><span style='color: red'>*</span>政治面貌：</td>
						<td class="formTdRight" style="width:25%">
							<select name="zhengzhimianmao1" id="zhengzhimianmao1" class="select" onchange="selChange(this.value)">
				...
				<table width="98%">
					...
					<tr>
						<td class="formTdLeft" style="width:25%"><span style='color: red'>*</span>出生年份：</td>
							<td class="formTdRight" style="width:25%">
							<input type="text" name="chushengnianfen2" value="" id="chushengnianfen2" class="input"/>
							
					<td class="formTdLeft" style="width:25%"><span style='color: red'>*</span>政治面貌：</td>
						<td class="formTdRight" style="width:25%">
							<select name="zhengzhimianmao2" id="zhengzhimianmao2" class="select"  onchange="selChange(this.value)">
							    <option value=" " selected="selected">请选择</option>
							     <option value="团员">团员</option>
							    <option value="党员">党员</option>
							    <option value="民主党派">民主党派</option>
				...
				<table width="98%">
					...
					<tr>
						<td class="formTdLeft" style="width:25%"><span style='color: red'>*</span>出生年份：</td>
							<td class="formTdRight" style="width:25%">
							<input type="text" name="chushengnianfen3" value="" id="chushengnianfen3" class="input"/>
							
					<td class="formTdLeft" style="width:25%"><span style='color: red'>*</span>政治面貌：</td>
						<td class="formTdRight" style="width:25%">
							<select name="zhengzhimianmao3" id="zhengzhimianmao3" class="select"  onchange="selChange(this.value)">
							    <option value=" " selected="selected">请选择</option>
							     <option value="团员">团员</option>
							    <option value="党员">党员</option>
							    <option value="民主党派">民主党派</option>
				...
				<table width="98%">
					...
					<tr>
						<td class="formTdLeft" style="width:25%"><span style='color: red'>*</span>出生年份：</td>
							<td class="formTdRight" style="width:25%">
							<input type="text" name="chushengnianfen4" value="" id="chushengnianfen4" class="input"/>
							
					<td class="formTdLeft" style="width:25%"><span style='color: red'>*</span>政治面貌：</td>
						<td class="formTdRight" style="width:25%">
							<select name="zhengzhimianmao4" id="zhengzhimianmao4" class="select" onchange="selChange(this.value)">
							    <option value=" " selected="selected">请选择</option>
							    <option value="团员">团员</option>
							    <option value="党员">党员</option>
							    <option value="民主党派">民主党派</option>
