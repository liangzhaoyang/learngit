...
public class Page implements Serializable {
	...
	private static final long serialVersionUID = 1168806367392255691L;

	protected int pageSize = 30; // 每页默认10条数据
...
//		setPagedView();
	...
	public void debug1() {
		...
		String debug = "共有数据数:" + totalRows + "共有页数:" + totalPages + "当前页数为:" + currentPage + "是否有前一页:" + hasPreviousPage + "是否有下一页:" + hasNextPage + "开始行数:" + pageStartRow
				+ "终止行数:" + pageEndRow;
	...
	public void setPagedView() {
		...
		sb.append("总数: " + totalRows + ", 共" + totalPages + "页, 第" + currentPage + "页, 转到 ");
