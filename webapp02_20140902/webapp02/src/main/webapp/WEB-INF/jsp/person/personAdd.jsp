...
<body>
	...
	<input type="hidden" name="leixing" value="${leixing}" id="leixing" class="input" readonly="readonly"  />
	<input type="hidden" name="panduan" value="" id="panduan" class="input" readonly="readonly"  />
