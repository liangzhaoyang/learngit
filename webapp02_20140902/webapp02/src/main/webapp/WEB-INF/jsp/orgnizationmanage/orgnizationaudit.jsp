...
<script type="text/javascript"
	src="<%=path%>/js/orgnizationmanage/orgnizationaudit.js"></script>
</head>
	...
	<div data-options="region:'center'" style="padding: 5px; border: 0">
		<form id="shenheConForm">
			<table width="90%">
				<tr>
					<td>机构名称：</td>
					<td><input type="text" name="orgname" id="orgname" maxlength="30"/></td>
					<td>机构类别：</td>
					<td><select id="leibieSelection" name="leibieSelection"
						class="select">
					...
					<td>成立时间范围：<input type="text" name="chenglishijianFrom"
						id="chenglishijianFrom" class="easyui-datebox" /> ~<input
						type="text" name="chenglishijianTo" id="chenglishijianTo"
						class="easyui-datebox" /></td>
				</tr>
				<tr>
					<td>经费来源：</td>
					<td><input type="text" name="jingfeilaiyuan"
						id="jingfeilaiyuan" maxlength="30"/></td>
					<td>行政级别：</td>
					<td><select id="jibieSelection" name="jibieSelection"
						class="select">
							<option value="0">请选择</option>
					...
					<td>是否政府序列： <select id="xulieSelection" name="xulieSelection"
						class="select">
							<option value="0">请选择</option>
					...
					<td align="center"><a id="btnSearch"
			...
			<!-- 
			<tr>
				<td>机构名称：</td><td><input type="text" name="orgname" id="orgname"/></td>
				<td>机构类别：</td><td>
			 ...
			 <tr>
				...
				<td>经费来源：</td><td><input type="text" name="jingfeilaiyuan" id="jingfeilaiyuan"/></td>
				<td>是否政府序列：</td><td>
